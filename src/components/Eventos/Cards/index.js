...
class Cards extends Component {
    ...
    render() {
        ...
        return (
            <div className="row">
                {listaEventos.map((item, index) => <div className="col col-lg-3 col-md-4 col-sm-6 col-xs-12 mt-2"><Card item={item} numero={index + 1} /></div>)}
            </div>
        );
    }
}
...
export default connect(mapStateToProps, { buscarTodosEventos })(Cards);